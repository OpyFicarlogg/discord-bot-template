...
*/
// Use of require-json5 because of the commentary in tsconfig.json
...
export default {
  ...
  //moduleNameMapper: pathsToModuleNameMapper(compilerOptions.paths), // Uncomment this line if you use paths in tsconfig.json
  //Do more with modulepaths: 
  /*moduleDirectories: [
    ".",
    "src",
    "node_modules"
